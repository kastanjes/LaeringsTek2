...
Shader "Vefects/SH_Vefects_URP_Render_Particles_Always_On_Top_Stroke_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _DepthFade;
			float _ErosionOutlineSmoothness;
			float _ErosionOutline;
						 ...
						 ) : SV_Target
			{
				...
				float4 lerpResult35 = lerp( input.ase_color , ( float4( tex2D( _LUT, panner42 ).rgb , 0.0 ) * input.ase_color ) , _ParticleColorLUT);
				float temp_output_76_0 = ( _Erosion + input.ase_texcoord3.w );
				float2 texCoord69 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord60 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner62 = ( 1.0 * _Time.y * _NoiseUVSpeed + ( texCoord60 * _NoiseUVScale ));
				float4 tex2DNode16 = tex2D( _MainTexture, ( texCoord69 + ( ( ( (tex2D( _NoiseTexture, panner62 ).rgb).xy + -0.5 ) * 2.0 ) * _DistortionIntensity ) ) );
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float temp_output_76_0 = ( _Erosion + input.ase_texcoord.w );
				float2 texCoord69 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord60 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner62 = ( 1.0 * _Time.y * _NoiseUVSpeed + ( texCoord60 * _NoiseUVScale ));
				float4 tex2DNode16 = tex2D( _MainTexture, ( texCoord69 + ( ( ( (tex2D( _NoiseTexture, panner62 ).rgb).xy + -0.5 ) * 2.0 ) * _DistortionIntensity ) ) );
				float smoothstepResult29 = smoothstep( temp_output_76_0 , ( temp_output_76_0 + _ErosionSmoothness ) , tex2DNode16.r);
				float temp_output_30_0 = saturate( smoothstepResult29 );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float temp_output_76_0 = ( _Erosion + input.ase_texcoord1.w );
				float2 texCoord69 = input.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord60 = input.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner62 = ( 1.0 * _Time.y * _NoiseUVSpeed + ( texCoord60 * _NoiseUVScale ));
				float4 tex2DNode16 = tex2D( _MainTexture, ( texCoord69 + ( ( ( (tex2D( _NoiseTexture, panner62 ).rgb).xy + -0.5 ) * 2.0 ) * _DistortionIntensity ) ) );
				float smoothstepResult29 = smoothstep( temp_output_76_0 , ( temp_output_76_0 + _ErosionSmoothness ) , tex2DNode16.r);
				float temp_output_30_0 = saturate( smoothstepResult29 );
...
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;63;-6400,512;Inherit;False;Property;_NoiseUVScale;Noise UV Scale;10;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;64;-6016,512;Inherit;False;Property;_NoiseUVSpeed;Noise UV Speed;11;0;Create;True;0;0;0;False;0;False;0.01,0.2;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;71;-4352,512;Inherit;False;Property;_DistortionIntensity;Distortion Intensity;12;0;Create;True;0;0;0;False;0;False;0.01;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;75;-3968,256;Inherit;False;Property;_Erosion;Erosion;13;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;31;-3968,384;Inherit;False;Property;_ErosionSmoothness;Erosion Smoothness;14;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;16;-3968,0;Inherit;True;Property;_MainTexture;Main Texture;1;0;Create;True;0;0;0;False;3;Space(33);Header(Main Texture);Space(13);False;-1;34f2aa06491110d42887449e8dc6c578;34f2aa06491110d42887449e8dc6c578;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;55;-1024,768;Inherit;False;Property;_DepthFade;Depth Fade;23;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;12;1024,0;Inherit;False;Property;_Dst;Dst;20;0;Create;True;0;0;0;True;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;13;1280,0;Inherit;False;Property;_ZWrite;ZWrite;21;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;10;512,0;Inherit;False;Property;_Cull;Cull;18;0;Create;True;0;0;0;True;3;Space(33);Header(AR);Space(13);False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;11;768,0;Inherit;False;Property;_Src;Src;19;0;Create;True;0;0;0;True;0;False;5;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;45;-768,128;Inherit;False;Property;_IsAdd;Is Add;4;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;14;1536,0;Inherit;False;Property;_ZTest;ZTest;22;0;Create;True;0;0;0;True;0;False;8;8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;40;-2816,-1024;Inherit;False;Property;_LUTAmplitude;LUT Amplitude;6;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;41;-2560,-1024;Inherit;False;Property;_LUTOffset;LUT Offset;7;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;43;-2304,-1024;Inherit;False;Property;_LUTPanSpeed;LUT Pan Speed;8;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;34;-2048,-1152;Inherit;True;Property;_LUT;LUT;5;0;Create;True;0;0;0;False;3;Space(33);Header(LUT);Space(13);False;-1;71d41510b1636cc4fb7c41676e85d496;71d41510b1636cc4fb7c41676e85d496;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;37;-1536,-640;Inherit;False;Property;_ParticleColorLUT;Particle Color / LUT;3;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;79;-3968,640;Inherit;False;Property;_ErosionOutlineSmoothness;Erosion Outline Smoothness;16;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;78;-3968,512;Inherit;False;Property;_ErosionOutline;Erosion Outline;15;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;83;-1282.17,-1161.06;Inherit;False;Property;_OutlineColor;Outline Color;17;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=F7205ED38BF369F49E92FDBC257C772C195BFE71